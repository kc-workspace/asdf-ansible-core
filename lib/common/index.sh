...
KC_ASDF_NAME="asdf-ansible-core"
KC_ASDF_REPO="https://github.com/kc-workspace/asdf-ansible-core"
export KC_ASDF_ORG KC_ASDF_NAME KC_ASDF_REPO

## Application information
KC_ASDF_APP_TYPE="python"
KC_ASDF_APP_NAME="ansible"
KC_ASDF_APP_WEBS="https://docs.ansible.com/"
KC_ASDF_APP_DESC="an agentless automation tool that you install on a single host (referred to as the control node)."
KC_ASDF_APP_REPO="https://github.com/ansible/ansible"
